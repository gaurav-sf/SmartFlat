...
public class SmartFlatDBTableCreation {
	...
	public static final String TABLE_FLAT_OWNER_DETAILS_CREATION_QUERY = "Create table if not exist "+TableNames.FLAT_OWNER_DETAILS
			+"( " 
	...
	public static final String TABLE_SOCIETY_DETAILS_CREATION_QUERY = "Create table if not exist "+TableNames.SOCIETY_DETAILS
			+"( "
	...
	public static final String TABLE_FAMILY_DETAILS_CREATION_QUERY = "Create table if not exist "+TableNames.FAMILY_DETAILS
			+"( "
	...
	public static final String TABLE_VEHICLE_DETAILS_CREATION_QUERY = "Create table if not exist "+TableNames.VEHICLE_DETAILS
			+"( "
	...
	public static final String TABLE_COMPLAINT_DETAILS_CREATION_QUERY = "Create table if not exist "+TableNames.COMPAINTS_DETAILS
			+"( "
	...
	public static final String TABLE_REQUEST_DETAILS_CREATION_QUERY = "Create table if not exist "+TableNames.REQUEST_DETAILS
			+"( "
	...
	public static final String TABLE_QUERY_DETAILS_CREATION_QUERY = "Create table if not exist "+TableNames.QUERY_DETAILS
			+"( "
	...
	public static final String TABLE_SOCIETY_NOTICES_CREATION_QUERY = "Create table if not exist "+TableNames.SOCIETY_NOTICES
			+"( "
